                ...
                <div class="box">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="nuevoVendedor" value="El usuario vendedor lgueado, el que esté en la sesión" readonly>
                    </div>
                  </div>
                  <!-- ENTRADA DE LA VENTA -->
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="nuevaVenta" value="El nº de factura por ejemplo" readonly>
                    </div>
                  </div>
                  <!-- ENTRADA DEL CLIENTE -->
                  <div class="form-group">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xs-7" style="padding-right: 0px;">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="agregarProducto" placeholder="Descripción del producto" required>
                      </div>
                    </div>
                    ...
                    <div class="col-xs-3" style="padding-left: 0px;">
                      <div class="input-group">
                        ...
                        <input type="number" min="1" class="form-control" name="nuevoPrecioProducto" placeholder="000000" readonly required>
                      </div>
                    </div>
                  </div>
