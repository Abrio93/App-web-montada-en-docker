...
class ModeloPublicaciones
{
    ...
    static public function mdlMostrarUsuarios($tabla, $campo, $valor)
    {
        ...
        if ($campo != null or $valor != null) {
            ...
            //? ESTE SE UTILIZA PARA COMPARAR EL USUARIO Y LA CONTRASEÑA DEL LOGIN CON EL DE LA BD (SE UTILIZA PARA EL LOGIN O PARA VER SI UN USUARIO YA EXISTE CUANDO VAMOS A CREAR UNO NUEVO)
    ...
    static public function mdlIngresarUsuario($tabla, $datos)
    {
        ...
        $conexion = Conexion::conectar();
        $sentencia = $conexion->prepare("INSERT INTO $tabla(nombre, usuario, password, imagen, correo, perfil, baneado) VALUES (:nombre, :usuario, :password, :imagen, :correo, :perfil, :baneado)");
        ...
        $sentencia->bindParam(":baneado", $datos["baneado"], PDO::PARAM_STR);
    ...
    {
        $conexion = Conexion::conectar();
        $sentencia = $conexion->prepare("UPDATE $tabla set nombre = :nombre, usuario = :usuario, password = :password, imagen = :imagen, correo = :correo, perfil = :perfil WHERE id = :id");
        ...
        // Mostrar detalles de la consulta preparada
        // return $sentencia->debugDumpParams();
    ...
    static public function mdlBorrarTodosUsuarios()
    {

        $conexion = Conexion::conectar();
        $sentencia = $conexion->query("DELETE FROM usuarios");
