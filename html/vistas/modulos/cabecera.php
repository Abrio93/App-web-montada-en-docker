<nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
            <div class="container-fluid"> <!--begin::Start Navbar Links-->
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block"> <a href="index.php?ruta=inicio" class="nav-link">Inicio</a> </li>
                    <li class="nav-item d-none d-md-block"> <a href="index.php?ruta=salir" class="nav-link">Salir</a> </li>
